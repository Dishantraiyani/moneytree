...
import com.github.drjacky.imagepicker1.util.ExifDataCopier
...
class CompressionProvider(activity: ImagePickerActivity) : BaseProvider(activity) {
    ...
    init {
        with(activity.intent.extras ?: Bundle()) {
            ...
            keepRatio = getBoolean(com.github.drjacky.imagepicker1.ImagePicker.EXTRA_KEEP_RATIO, false)
        }
    }
    ...
    fun compress(uri: Uri) {
        activity.lifecycleScope.launch {
            ...
            if (res != null) {
                ...
                setError(com.github.drjacky.imagepicker1.R.string.error_failed_to_compress_image)
            }
        }
    }
