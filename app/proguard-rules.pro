...
-obfuscationdictionary methods.txt
-classobfuscationdictionary classes.txt
-packageobfuscationdictionary packages.txt
...
-keep class com.moneytree.app.repository.network.requests.** { *; }
-keep class com.moneytree.app.repository.network.responses.** { *; }
