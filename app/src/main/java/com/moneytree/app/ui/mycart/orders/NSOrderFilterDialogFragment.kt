...
class NSOrderFilterDialogFragment : DialogFragment() {
    ...
    private val productModel: NSOrderViewModel by lazy {
        ViewModelProvider(requireParentFragment())[NSOrderViewModel::class.java]
    }

    companion object {
        fun newInstance(callback: NSProductFilterCallback): NSOrderFilterDialogFragment {
            val fragment = NSOrderFilterDialogFragment()
    ...
    private fun setupView() {
        binding.apply {
            ...
            ivDiseasesType.setImageResource(R.drawable.ic_filter)
    ...
    private fun observeViewModel() {
        productModel.isCategoryDataAvailable.observe(viewLifecycleOwner) { categoryData ->
            ...
            brandList.clear()
            brandList.addAll(categoryData.brandList)
        }
    }
