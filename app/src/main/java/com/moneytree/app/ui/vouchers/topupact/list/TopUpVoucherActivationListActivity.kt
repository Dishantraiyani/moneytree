...
class TopUpVoucherActivationListActivity : NSActivity() {
    ...
    private fun loadInitialFragment() {
        replaceCurrentFragment(TopupVoucherActivationListFragment.newInstance(), false, binding.commonContainer.id)
    }
}
