 ...
 */
class SponsorListViewModel(application: Application) : NSViewModel(application),
    ...
    fun getSponsorListData(isShowProgress: Boolean, joiningVoucherCallBack: NSJoiningVoucherCallback) {
