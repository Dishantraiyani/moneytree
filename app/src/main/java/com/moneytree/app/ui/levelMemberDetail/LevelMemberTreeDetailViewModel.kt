 ...
 */
class LevelMemberTreeDetailViewModel(application: Application) : NSViewModel(application),
    NSGenericViewModelCallback {
    var levelNumber: String? = null
    var memberList: MutableList<NSLevelMemberTreeDetail> = arrayListOf()
    var isMemberDataAvailable = MutableLiveData<Boolean>()
    private var memberResponse: NSLevelMemberTreeDetailResponse? = null
    ...
    override fun <T> onSuccess(data: T) {
        isProgressShowing.value = false
        val memberMainListData = data as NSLevelMemberTreeDetailResponse
