...
class NSCategoryListRecycleAdapter(private val onClickResponse: NSProductCategoryCallback) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val voucherView = LayoutCategoryItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
     ...
     */
    inner class NSCategoryViewHolder(private val voucherBinding: LayoutCategoryItemBinding) :
        ...
        fun bind(response: NSCategoryData) {
            with(voucherBinding) {
                with(response) {
					...
					clCategory.setOnClickListener(object : SingleClickListener() {
