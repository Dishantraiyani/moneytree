...
/**
 * The view model class for royalty. It handles the business logic to communicate with the model for the royalty and provides the data to the observing UI component.
 */
