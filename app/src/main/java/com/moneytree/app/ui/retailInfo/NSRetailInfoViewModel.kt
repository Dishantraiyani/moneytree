...
/**
 * The view model class for retail info. It handles the business logic to communicate with the model for the retail info and provides the data to the observing UI component.
 */
