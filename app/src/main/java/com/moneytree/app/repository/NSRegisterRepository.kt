...
object NSRegisterRepository {
     ...
     */
    fun getRegisterListData(pageIndex: String, search: String, type: String, startDate: String, endDate: String,
        viewModelCallback: NSGenericViewModelCallback
    ) {
        apiManager.getRegisterListData(pageIndex, search, type, startDate, endDate, object :
